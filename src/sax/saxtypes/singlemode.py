...
arrays and a port map. The three arrays represent the output port indices [`int`] (rows),
input port indices [`int`] (columns) and the S-matrix values [`ComplexFloat`] of the sparse
